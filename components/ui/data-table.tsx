                ...
                <TableRow
                  ...
                  {row.getVisibleCells().map((cell) => {
                    ...
                    if (cell.column.id === "hasReply") {
                      cellStyle = {
                        color: cell.getValue() === "Sim" ? "#84CC16" : "red",
                      };
                    }
                    ...
                    return (
                      <TableCell
                        ...
                        style={cellStyle}
                        className={cn(
                          cell.column.id === "stock" ? "pl-10" : "",
                          cell.column.id === "number" ? "pl-10" : "",
                          cell.column.id === "price" ? "pl-6" : "",
                          cell.column.id === "name" ? "pl-6" : "",
                          cell.column.id === "rating" ? "pl-5" : "",
                          cell.column.id === "hasReply" ? "pl-6" : ""
                        )}>
                        {flexRender(

...
import { DeleteColorsButton } from "./delete-colors";

interface ColorsDataTableProps<TData, TValue> {
...
export function ColorsDataTable<TData, TValue>({
  columns,
  data,
  searchKey,
}: ColorsDataTableProps<TData, TValue>) {
      ...
      <div className="flex items-center justify-between py-4">
        ...
        <div className="flex items-center space-x-5">
          {table.getFilteredSelectedRowModel().rows.length > 0 && (
            <DeleteColorsButton colorsIds={selectedColorsIds} />
          )}

...
CREATE TABLE "Product" (
    ...
    "discountAbsolute" INTEGER DEFAULT 0,
...
-- CreateIndex
CREATE UNIQUE INDEX "TwoFactorConfirmation_myUserId_key" ON "TwoFactorConfirmation"("myUserId");
...
-- AddForeignKey
ALTER TABLE "Account" ADD CONSTRAINT "Account_myUserId_fkey" FOREIGN KEY ("myUserId") REFERENCES "MyUser"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Account" ADD CONSTRAINT "Account_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "TwoFactorConfirmation" ADD CONSTRAINT "TwoFactorConfirmation_myUserId_fkey" FOREIGN KEY ("myUserId") REFERENCES "MyUser"("id") ON DELETE CASCADE ON UPDATE CASCADE;
